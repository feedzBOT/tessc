...
%readmore`
    ...
    text = text.replace(new RegExp(`%(${Object.keys(replace).sort((a, b) => b.length - a.length).join`|`})`, 'g'), (_, name) => ''+replace[name])
conn.fakeReply(m.chat, `sabar!!`, '0@s.whatsapp.net','*Hadehhhhhhh*')
await conn.send2ButtonImg(m.chat, text.trim(), `./cewe/${pickRandom(['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q'])}.jpg`, `B o t t i - B O T  | Bot by @${owner[0]}`, 'Donasi', '.ds', 'Script', '.owner', { quoted: fvideo, sendEphemeral: true, contextInfo: { mentionedJid: conn.parseMention(text), forwardingScore: 135,                 isForwarded: true ,"externalAdReply": {
          "title": `${pickRandom(['palpale','awokwkwkw','awikwok','duk tak duk'])}`,
          "body": `${pickRandom(['follow bang','© H i - F E 3 D Z','Kok bisa bang','Waduh bang','Pencet lah'])}`,
          "mediaType": "1",
          ...
          "mediaUrl": `${pickRandom(['https://wa.me/12092602649','https://instagram.com/hfidzzy_','https://github.com/Nurutomo','https://wa.me/6288705834498?text=Sv+bang'])}`,
     //     "thumbnail": "https://i.ibb.co/ysTv8wY/Screenshot-20210808-112316.png",
         "sourceUrl": `${pickRandom(['https://wa.me/12092602649','https://instagram.com/hfidzzy_','https://github.com/Nurutomo','https://wa.me/6288705834498?text=Sv+bang'])}`,
           }}})
/* await conn.send2ButtonImg(m.chat, text.trim(), './src/hehe.jpg', 'B o t t i - B O T | Bot by @${owner[0]}`, 'Donasi', '.ds', 'Script', '.owner', 'conversation', { sendEphemeral: true, quoted: fvideo, contextInfo : { mentionedJid: conn.parseMention(text), forwardingScore: 135,
                isForwarded: true ,"externalAdReply": {
          "title": `${pickRandom(['palpale','awokwkwkwkw','awikwok','duk tak duk'])}`,
          "body": `${pickRandom(['follow bang','hifeedz','Pencet lah'])}`,
          "mediaType": "1",
          "thumbnailUrl": `${pickRandom(['https://telegra.ph/file/6e33a92a7917a6da614c8.png','https://telegra.ph/file/4d55bd6548fe15f3929e8.png','https://telegra.ph/file/358bd1243061f415225e2.png','https://telegra.ph/file/8208c148ab682cf7bd12a.png'])}`,
          "mediaUrl": `${pickRandom(['https://wa.me/12092602649','https://instagram.com/hfidzzy_','https://github.com/Nurutomo','https://wa.me/6288705834498?text=Sv+bang'])}`,
     //     "thumbnail": "https://i.ibb.co/ysTv8wY/Screenshot-20210808-112316.png",
